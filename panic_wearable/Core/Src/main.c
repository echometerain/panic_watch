...
/* USER CODE BEGIN PV */
bool prev_button_on = true;
bool panick_mode = false;

Lcd_PortType ports[] = { GPIOC, GPIOC, GPIOC, GPIOC, GPIOC, GPIOC, GPIOC,
GPIOC };
